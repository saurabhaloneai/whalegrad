# import sys
# sys.path.insert(0, '/Users/sasaurabhurabhvaishubhalone/Desktop/whalegrad/whalegrad/engine') 
...
class Optimizer:
  ...
  def zero_grad(self, all_members=False):
    '''Resets the grads of Whalors

    By default, since after loss.backward, only Whalors in memory are the params, only their
